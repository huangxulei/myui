...
class DrawPlugin extends GPTPluginInterface {
  ...
  String get description =>
      'Draw a picture using DALL·E-3. Not recommended to use the GPT3.5 ';
  ...
  List<GPTPluginMethod> get methods {
    return [
      GPTPluginMethod(
          'dall_e_draw',
          'Draw a picture and return the URL and description of the picture. You need to use ![img](url) to display the picture.',
          [
  ...
  Future<String> execute(String method, Map<String, dynamic> params,
    ...
    if (method == 'dall_e_draw') {
      ...
      if (params['size'] != null &&
          !['1024x1024', '1792x1024', '1024x1792'].contains(params['size'])) {
