...
import 'package:myui/components/chat/PluginItem.dart';
import 'package:myui/components/chatHistoryController.dart';
import 'package:myui/gpt/plugins/impl/core.dart';
    ...
    _focusNode.addListener(() {
      if (!_focusNode.hasFocus) {
        controller.currentChat.update((val) {
          ...
          chatHistoryController.updateChatName(
              ...
              onPressed: () {
                Util.pickAndSaveImage().then((value) {
                  ...
                  Util.writeFile(
                      ...
                      jsonEncode(controller.currentChat.value));
                  chatHistoryController.updateChatAvatar(
                          ...
                          children: [
                            ...
                            Text(
                              controller.currentChat.value.plugins.isEmpty
                                  ? 'Select plugins for this chat'
                                  : '${controller.currentChat.value.plugins.length} plugins selected',
                              style: const TextStyle(
                                color: Colors.grey,
                                fontSize: 12,
                                fontWeight: FontWeight.bold,
