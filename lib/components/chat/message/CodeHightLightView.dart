...
import 'package:myui/components/chat/message/my_flutter_highighter.dart';
  ...
  Widget? visitElementAfter(md.Element element, TextStyle? preferredStyle) {
    ...
    if (language == 'call-function') {
      String name = element.textContent.contains("!end")
          ? element.textContent
              .substring(0, element.textContent.indexOf("!end"))
          : element.textContent;
      GPTPluginInterface plugin =
          GPTPluginController.getByFunctionName(name.replaceAll("\n", ""));
      return Container(
        color: Colors.white,
        child: Row(
          children: [
